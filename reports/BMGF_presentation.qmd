...
format:
  revealjs:
    ...
    slide-number: true
    incremental: true
    footer: "Micronutrient Data Innovation Alliance"
execute:
  echo: true
  warning: false
  message: false
...
- Phases  
  ...
  3. Expansion (contingent on Phase 2 success)
...
# Micronutrient survey coverage

```{r fig-dhs-domains, eval=FALSE}
...
- UCB subaward total: **$321,067** across two years  
- Year 1 direct costs: $143,176, IDC 10%  
- Personnel: PI (Hubbard 7%), Co‑PI (Mertens 25%), GSR 50%, UG assistant 15 h/wk
